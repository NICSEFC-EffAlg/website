...
<div style="display: flex; flex-wrap: wrap; margin: 20px 0;">
    ...
    <div style="flex: 0 0 70%; padding: 10px; padding-left: 50px;  font-size: 18px;">
        <div style="margin-bottom: 30px;">
          ...
          <b><span style="color: #FF3333;">NOTE in 2025:</span> From 2025, I personally may not be able to advise or participate in many project within my team. Some managing stuffs will also be handed on to Shiyao Li and Tianchen Zhao. Despite that, I think that we have already established strong pipelines of doing things, a comprehensive knowledge base, a solid platform, and more importantly, a great team for new students to find their collaboration and grow in our team. Therefore, we continue to welcome visiting students. </b>
        </div>
    </div>
</div>
<!-- End of Selection -->
